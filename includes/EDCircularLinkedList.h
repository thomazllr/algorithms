...
#ifndef ALGORITHMS_EDCIRCULARLINKEDLIST_H
#define ALGORITHMS_EDCIRCULARLINKEDLIST_H
...
int Josephus(CircList *L, int pulos);


#endif //ALGORITHMS_EDCIRCULARLINKEDLIST_H
